...
public interface CreditRecordMapper {
    ...
    public int todaySignRecord(String userId,int ruleCode,String today);
    ...
    public int consumeCredit(int id);
    @Update("update usablecredit set credit=#{credit} where id=#{id}")
    public int updateCredit(int id,int credit);
    ...
    public int insertUsableCredit(String userId,int recordId,int credit,String createTime,String expiredTime);
    ...
    public int insertReducecredit(String userId,int recordId,int usableId,int credit,String createTime,String expiredTime);
}
