...
\begin{CJK*}{UTF8}{song}                             % 开始中文字体使用
	...
	%%%%%% 这里是正文，每个文件对应正文中的一章 %%%%%%
	\include{body/members} %任务分工
	\include{body/requirement} %项目需求
	\include{body/part1} %第一项目
	\include{body/part2} %第二项目
	\include{body/part3} %第三项目
	\include{body/part4} %第四项目
	\include{body/feature} %项目特色之处
	\include{body/development} %项目开发过程
	\include{body/problem} %项目中遇到的问题及解决方法
